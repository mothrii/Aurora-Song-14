...
uplink-adder-desc = One state-of-the-art Adder pistol, bundled with 2 canisters of Echion fuel.

uplink-akurra-name = Akurra bundle
uplink-akurra-desc = Fearsome as it is advanced, the venerable Akurra bundled with 4 canisters of Echion fuel.
...
uplink-magazine-echion-desc = A special refueling canister containing 30 units of Echion. Compatible with the Adder, Akurra, Ananke, and Glykon.

uplink-echion-synth-name = Echion synthesizer
uplink-echion-synth-desc = An advanced catalyser that produces Echion at a steady rate while powered. Compatible with the Adder, Akurra, Ananke, and Glykon.
...
uplink-ananke-desc = Brutal and unapolagetic-- the Ananke shotgun, bundled with 4 canisters of Echion fuel.
